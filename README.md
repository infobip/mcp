...
- ✉️ View metrics, billing usage, error-code lookups, and cross-channel message logs
...
|![Early Access](https://img.shields.io/badge/early%20access-F97316?style=flat-square&color=F97316&logoColor=white) **Observe** | `https://mcp.infobip.com/observe` | View metrics, billing usage, error-code lookups, and cross-channel message logs. These are read-only tools an agent can call to reason about the traffic it already sent. |
